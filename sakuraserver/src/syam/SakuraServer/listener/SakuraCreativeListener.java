/**
 * sakuraserver - Package: syam.SakuraServer.listener Created: 2012/11/24
 * 6:07:35
 */
...
public class SakuraCreativeListener implements Listener {
    ...
    public void onPlayerItemHeldEvent(final PlayerItemHeldEvent event) {
        ...
        if (!player.getWorld().getName().equals("creative") || player.hasPermission("sakura.creative.itembypass")) { return; }
