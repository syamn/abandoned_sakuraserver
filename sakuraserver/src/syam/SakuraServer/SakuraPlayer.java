...
public class SakuraPlayer {
    ...
    public SakuraPlayer(String name) {
        ...
        String filename = SakuraServer.getInstance().getDataFolder() + System.getProperty("file.separator") + "userData" + System.getProperty("file.separator") + name + ".yml";
    ...
    public boolean load() {
        if (!file.exists()) {
            ...
            saved = false;
            if (!save()) { throw new IllegalArgumentException("新しいプレイヤーデータを作れませんでした"); }
        }
